...
class ExpenseSkuDaySummaryQueryAPI:
    METHOD = 'wdt.hjy.expense.sku.day.summary.main.query'
    ...
    @staticmethod
    def _to_list_str(value: Union[str, List[str], None]) -> Optional[str]:
    ...
    def query(
        self,
        business_date: str,
        shop_no: Union[str, List[str], None] = None,
        spec_no: Union[str, List[str], None] = None,
        summary_no: Union[str, List[str], None] = None,
        expense_item_name: Union[str, List[str], None] = None,
        ...
        shop_no_str = self._to_list_str(shop_no)
        spec_no_str = self._to_list_str(spec_no)
        summary_no_str = self._to_list_str(summary_no)
        expense_item_name_str = self._to_list_str(expense_item_name)

        if shop_no_str:
            sign_params['shopNo'] = shop_no_str
        if spec_no_str:
            sign_params['specNo'] = spec_no_str
        if summary_no_str:
            sign_params['summaryNo'] = summary_no_str
        if expense_item_name_str:
            sign_params['expenseItemName'] = expense_item_name_str
    ...
    def query_all(
        ...
        while True:
            ...
            result = self.query(
                ...
                expense_item_name=expense_item_name,
