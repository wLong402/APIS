#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""对账正应收汇总：wdt.hjy.recon.order.confirm.summary.query"""
...
def _emit_debug(msg: str) -> None:
    ...
    try:
        ...
        get_logger('connector.wdt.recon_order_confirm_summary').info(msg)
    except Exception:
        pass
...
class ReconOrderConfirmSummaryQueryAPI:
    METHOD = 'wdt.hjy.recon.order.confirm.summary.query'
    PAGE_SIZE = 200
    ...
    def query(
        ...
        shop_name: Optional[List[str]] = None,
        ...
        v = self._format_array_param(shop_name, 'json')
        if v:
            sign_params['shopName'] = v
