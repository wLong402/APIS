...
class MarketingDetailQueryAPI:
    METHOD = 'wdt.hjy.bill.marketing.detail.query'
    PAGE_SIZE = 200
    ...
    def query(self,
        ...
        if debug:
            ...
            debug_print(f"      [REQUEST DEBUG] Body: {api_params}")
    ...
    def query_date_range(self,
        ...
        if debug:
            debug_print(f"    [DEBUG] 查询 {len(dates_to_query)} 天的数据...")
