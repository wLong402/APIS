...
class ProfitsSkuQueryAPI:
    METHOD = 'wdt.hjy.ba.profits.sku.query'
    ...
    def query(
        ...
        display_by_shop: Optional[str] = None,
        display_by_date: Optional[str] = None,
        ...
        sign_params = {
            ...
            'compositeDim': str(composite_dim),
        ...
        if display_by_shop is not None:
            sign_params['displayByShop'] = str(display_by_shop)
        if display_by_date is not None:
            sign_params['displayByDate'] = str(display_by_date)
    ...
    def query_all(
        ...
        while True:
            ...
            result = self.query(
                ...
                stat_mode=stat_mode,
                order_way=order_way,
                display_by_shop=display_by_shop,
